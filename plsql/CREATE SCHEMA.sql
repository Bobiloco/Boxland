...
/*
-- Rebuilds indexes, gathers stats and reparses queries on all tables
declare
...
-- Natively compile procedures
BEGIN
FOR cur in ( select object_type, object_name from user_procedures )
LOOP
...
( EVENT_CHOICE_ID INTEGER NOT NULL
, CT0             CHAR(10)
, CT1             CHAR(10)
, CT2             CHAR(10)
, CT3             CHAR(10)
...
( EVENT_CHOICE_ID INTEGER NOT NULL
, CHOICE_FACING   INTEGER NOT NULL
, CHOICE_TARGET   CHAR(10)
...
( EVENT_HIST_ID     INTEGER NOT NULL 
, EVENT_DECISION_ID INTEGER NOT NULL 
